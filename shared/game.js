...
import { createBoard, applyBoardLook, BOARD_THEMES, boardUrl } from './board.js?v=1790337006';
import { aiMove, hintMove } from './ai.js?v=1790337006';
import { mountOpponent, LEVEL_NAMES } from './opponent.js?v=1790337006';
...
export function startGame(cfg) {
  ...
  if (cfg.navOnly) {
    ...
    // збиті фігури обох — одним рядком під дошкою (зліва — суперника, справа — твої); фон суперника — до самої дошки
