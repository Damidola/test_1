...
import { createBoard, applyBoardLook, BOARD_THEMES, boardUrl } from './board.js?v=1790415265';
import { aiMove, hintMove } from './ai.js?v=1790415265';
import { mountOpponent, LEVEL_NAMES } from './opponent.js?v=1790415265';
  ...
  if (cfg.navOnly) {
    ...
    if (home) {
      ...
      snd.addEventListener('click', () => {
        ...
        if (!LG.muted && LG.volume <= 0) { LG.volume = 1; LG.store.set('volume', LG.volume); }
