...
import { OPPONENTS, LEVEL_NAMES } from './shared/opponent.js?v=1790416027';
import { BOARD_THEMES, boardUrl } from './shared/board.js?v=1790416027';
import { SECTIONS, STEPS, P, W } from './shared/path.js?v=1790416027';
...
const PRACTICE = [
  ...
  { id: 'analysis', ic: '🔍', t: 'Аналіз', s: 'ходи як хочеш — робот підкаже найкращий хід', c: '#3FA7F5', href: 'games/index.html?fen=' + encodeURIComponent('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1') },
