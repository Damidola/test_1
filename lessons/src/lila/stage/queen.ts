...
const stage: StageNoID = {
  ...
  levels: [
    ...
    { goal: 'Ферзь проти 8 пішаків: побий усіх! Не дай жодному дійти до нижнього краю 🏁', fen: '8/pppppppp/8/8/8/8/8/3Q4 w - -', nbMoves: 30, game: 'vsPawns', cssClass: 'lg-finish-bottom' },
  ].map(toLevel),
