// Замінник глобального «site» з lila для уроків: звуки Lichess (lessons/assets/sound) через звук і гучність сайту,
...
// Звуки Lichess (lessons/assets/sound, з lila public/sound) — тим самим програвачем сайту (Web Audio, без затримки)
